...
\item[Forest confidence] An expectation requires a probability distribution over the $n$-best
...
\cite{owczarzak07labelleddepseval} \textbf{d\_50} and
\textbf{d\_50\_var} measures.\footnote{Since
  \cite{owczarzak07labelleddepseval} report no use of parse
...
\subsection{Reference evaluation measures}

TO DO: TALK ABOUT HUMAN F/A JUDGMENTS
